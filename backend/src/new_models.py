...
class Sample(db.Model):
    ...
    batch_id: int = db.Column(db.Integer, db.ForeignKey('batch_table.id'))
    flock_id: int = db.Column(db.Integer, db.ForeignKey('flock_table.id'))
    cartridge_id: int = db.Column(db.Integer, db.ForeignKey('cartridge_table.id')
    machine_id: int = db.Column(db.Integer, db.ForeignKey('machine_table.id')
...
class Cartridge(db.Model):
    ...
    id: int = db.Column(db.Integer, primary_key=True, autoincrement=True)
    rotor_lot_number: int = db.Column(db.Integer)
    cartridge_type_id: int = db.Column(db.Integer, db.ForeignKey('cartridge_type_table.id'))
...
class CartridgeType(db.Model):
    """ This table stores the cartridge types.

    It pretty much just stores the names of the cartridge types.
